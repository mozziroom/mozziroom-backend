...
class TokenProviderTest {
    ...
    void createAccessToken() {
        // given
        TokenProvider tokenProvider = TokenProviderFixture.create(10000, 10000);
        Long memberId = 1L;
        String role = "ROLE_USER";

        // when
        String token = tokenProvider.issueAccessToken(memberId, role);
    ...
    void createRefreshToken() {
        ...
        // when
        RefreshToken refreshToken = tokenProvider.issueRefreshToken(memberId, role);
    ...
    void validateAccessTokenReturnFalse() throws InterruptedException {
        // given
        TokenProvider tokenProvider = TokenProviderFixture.create(1000, 10000);
        Long memberId = 1L;
        String role = "ROLE_USER";
    ...
    void validateRefreshTokenReturnFalse() throws InterruptedException {
        // given
        TokenProvider tokenProvider = TokenProviderFixture.create(1000, 1000);
        Long memberId = 1L;
        String role = "ROLE_USER";
